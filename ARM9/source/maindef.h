...
#define ROMVERSION "Ver 2.00"
#define ROMDATE ""__DATE__" "__TIME__" GMT+08:00"
#define ROMDATESHORT ""__DATE__" "__TIME__""
#define ROMENV "ARM RVCT4.0 [Build 471]"
...
enum ENextProc {ENP_Loop,ENP_ChkDsk,ENP_Setup,ENP_FileList,ENP_SysMenu,ENP_DPGCustom,ENP_DPGPlay,ENP_ImageCustom,ENP_ImageView,ENP_TextCustom,ENP_TextView,ENP_Launch,ENP_Custom,ENP_BootROM,ENP_SetupW,ENP_Cheat,ENP_ROMSET,ENP_ShutDown,ENP_CpyCut,ENP_GBA,ENP_ReMenu};
...
extern void ProcSetupW_SetCallBack(TCallBack *pCallBack);
extern void ProcCheat_SetCallBack(TCallBack *pCallBack);
extern void ProcRomSet_SetCallBack(TCallBack *pCallBack);
extern void ProcShutDown_SetCallBack(TCallBack *pCallBack);
extern void ProcCpyCut_SetCallBack(TCallBack *pCallBack);
extern void ProcGBA_SetCallBack(TCallBack *pCallBack);
