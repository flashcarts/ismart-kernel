...
extern void Skin_Load_TextView_AfterLoad(void);
extern void Skin_Load_Launch(void);
extern void Skin_Load_Custom(void);
extern void Skin_Load_BootROM(void);

extern void Skin_Load_SetupW(void);
extern void Skin_Load_Cheat(void);
extern void Skin_Load_RomSet(void);
extern void Skin_Load_ShutDown(void);
extern void Skin_Load_CpyCut(void);
extern void Skin_Load_GBA(void);

extern void Skin_Free(void);


extern CglTGF* Skin_GetNDSinfo(void);
...
enum EFileListSkinAlpha {EFLSA_ItemBG_Clear,EFLSA_ItemBG_Select,EFLSA_ItemBG_PlayIcon,
                        ...
                        /* EFLSA_Icon_Sound,EFLSA_Icon_Image,EFLSA_Icon_Video,*/EFLSA_Icon_NDSROM,//EFLSA_Icon_Skin,EFLSA_Icon_Text,
                         EFLSA_Icon_GBA,
                         EFLSA_Icon_UnknownFile_EXT,
                         EFLSA_Icon_UpFolder_EXT,EFLSA_Icon_Folder_EXT, EFLSA_Icon_GBA_EXT,                        
                         EFLSACount};
...
enum EScrollBarSkinAlpha {ESBSA_BG,
                         ...
                         /* EFLSA_Icon_FILEINFO,EFLSA_Icon_sun,EFLSA_Icon_reset0,EFLSA_Icon_reset1,*/EFLSA_Btn_set0,EFLSA_Btn_set1,
                         /* EFLSA_top_bar,EFLSA_bottom_bar,EFLSA_scroll_block,*/EFLSA_scroll_bar,
                          EFLSA_bright_up,EFLSA_bright_down,EFLSA_reserve_up,EFLSA_reserve_down,EFLSA_help_up,EFLSA_help_down,
                          EFLSA_setup_up,EFLSA_setup_down,EFLSA_shut_up,EFLSA_shut_down,EFLSA_up_up,EFLSA_up_down,
                          EFLSA_down_up,EFLSA_down_down,EFLSA_run_up,EFLSA_run_down,
                          EFLSA_NO_MS2,
                          ESBSACount};
...
enum EMoviePlayerSkinAlpha {EMPSA_mode_repeat,EMPSA_mode_allrep,EMPSA_mode_random,
                            EMPSA_modelbl_repeat,EMPSA_modelbl_allrep,EMPSA_modelbl_random,
...
enum EMP3CntSkinAlpha {EMP3SA_p0,
                       ...
                       EMP3SA_p3_next,
                       EMP3SA_p4_repeat,EMP3SA_p4_allrep,EMP3SA_p4_random,
                       EMP3SACount};
...
extern CglTGF* SetupWAlpha_GetSkin(ESetupWSkinAlpha SetupWSkinAlpha);

enum ECheatSkinAlpha {ECWSA_CheatBG,ECWSA_Opt_NO,ECWSA_Opt_YES,ECWSA_ItemBG_Select,ECWSA_Sub,ECWSA_Mul,
						ECWSACount};

extern CglTGF* CheatAlpha_GetSkin(ECheatSkinAlpha CheatSkinAlpha);


enum ERomSetSkinAlpha {ERSSA_RomSetBG,ERSSACount};
extern CglTGF* RomSetAlpha_GetSkin(ERomSetSkinAlpha RomSetSkinAlpha);

enum EShutDownSkinAlpha {ESDSA_ShutDownBG,ESDSACount};
extern CglTGF* ShutDownAlpha_GetSkin(EShutDownSkinAlpha ShutDownSkinAlpha);

enum ECpyCutSkinAlpha {ECCSA_CpyCutBG,ECCSA_progrss_bar_bg,ECCSA_progress_bar,ECCSACount};
extern CglTGF* CpyCutAlpha_GetSkin(ECpyCutSkinAlpha CpyCutSkinAlpha);

enum EGBASkinAlpha {EGBASA_GBABG,EGBASA_progrss_bar_bg,EGBASA_progress_bar,EGBASACount};
extern CglTGF* GBAAlpha_GetSkin(EGBASkinAlpha GBASkinAlpha);

enum EBootRomSkinAlpha {EBRSA_BootRomBG,EBRSA_progress_bar,EBRSACount};
extern CglTGF* BootRomAlpha_GetSkin(EBootRomSkinAlpha BootRomSkinAlpha);
...
extern void Skin_ClearCustomBG(void);
...
typedef struct {
  ...
  u16 PopupFrame;
  u16 PopupText;
  u16 ID3TagWhiteModeText;
  u16 ID3TagBlackModeText;
...
typedef struct {
  ...
  TColorTable_Calender Calender_White,Calender_Black;
  TColorTable_ZV ZV_SYSTEM;
} TColorTable;
