...
{
  static ETriggerType TriggerType;
  if(Init==true){
    TriggerType=ETT_AButton;
  }
  
  static bool Process;
  static bool WaitLongEnd,ProcessingLong,ProcessingSingleLong,ProcessingDoubleLong;
  if(Init==true){
    Process=false;
    WaitLongEnd=false;
  ...
  static u32 ClickCount;
  static u32 LeaveTime;
